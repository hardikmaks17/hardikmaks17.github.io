        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              ...
              with 4+ years of experience building scalable, accessible, and
              high-performance web applications. I specialize in
              <span className="text-primary"> React, TypeScript</span>, and
              modern UI frameworks.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              My focus is on clean architecture, reusable components, and
              pixel-perfect design implementation. I believe in writing code
              that is not only functional but also maintainable and elegant.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              When I'm not coding, I'm exploring new technologies, contributing
              to open-source projects, or mentoring aspiring developers in their
              journey.
            </p>
          </motion.div>
