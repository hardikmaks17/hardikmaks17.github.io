...
import { Mail, Linkedin, Github, Download, Send, ArrowRight } from "lucide-react";
...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, label: "LinkedIn", href: "https://linkedin.com", value: "linkedin.com/in/yourprofile" },
    { icon: Github, label: "GitHub", href: "https://github.com", value: "github.com/yourprofile" },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                ...
                <h3 className="font-display font-semibold text-lg mb-2">Download Resume</h3>
